...
## The IDE
We built a fully in-browser cursor-like IDE using [Monaco](https://monaco.microsoft.com) as the text editor with syntax highlighting, [WebContainer](https://webcontainer.io) as the unix container that runs web previews etc..., [zen-fs](https://github.com/zen-fs/) as the filesystem, and [React](https://react.dev) + [Tailwind](https://tailwindcss.com/) for the frontend bringing it all together.

### The AI
We used the vercel [AI SDK](http://ai-sdk.dev/) + Claude Sonnet 4.5 as the underlying model powereing the AI features including chat, assignment generation, and grading.
